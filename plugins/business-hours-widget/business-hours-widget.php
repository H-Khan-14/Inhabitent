 ...
 * @author    Haseeb Khan <email@example.com>
 * @license   GPL-2.0+
 ...
 * Plugin URI:        @TODO
 * Description:       A widget to display the business hours of our ficticious company.
 * Version:           1.0.0
 * Author:            Haseeb Khan
 * Author URI:        @TODO
 * License:           GPL-2.0+
...
function inhabitent_business_hours() {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'This widget shows the Business Hours.'
			)
		);
